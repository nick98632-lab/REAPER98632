...
# =============================================================================
# EMPERICALCUTOFF.R
# PRIMARY WEIGHTED-PARETO ANALYSIS + ZERO-ARM SENSITIVITY CHECK
# =============================================================================
...
# =============================================================================
# INTEGRATED ZERO-ARM NB-EXCESS SENSITIVITY CHECK
# =============================================================================
#
# The primary weighted-Pareto analysis above is the manuscript analysis.
#
# This second section is a sensitivity analysis for a specific edge case:
# a feature may be all zero in one experimental arm while the globally pooled
# within-group variance V_pool,i remains positive because that feature varies
# in other arms. Under the primary formula
#
#     E_ig = max(V_pool,i - mu_ig, 0)
#
# an all-zero arm can therefore receive positive NB-excess mass.
#
# This integrated diagnostic:
#
#   1. counts all-zero feature/arm combinations;
#   2. quantifies how much current NB-excess mass they receive;
#   3. creates a sensitivity copy in which
#
#          if sum_j Y_ij = 0 within arm g, then E_ig = 0;
#
#   4. leaves the PC1 ranking and raw-count variance geometry unchanged;
#   5. refits the shared cumulative-divergence c1/c2 boundaries;
#   6. reruns the same c1-based weighted-Pareto top-k optimization; and
#   7. reports how much c1, c2, and the final global k* move.
#
# IMPORTANT:
# This does NOT silently replace the primary method.  Both the primary and
# zero-masked sensitivity results are produced in the same run so that the
# effect of this edge case can be evaluated directly.
#
# Diagnostic outputs are written under:
#
#   <OUT_ROOT>/ZeroArm_NB_Diagnostic/
#
# =============================================================================

message("")
message("============================================================")
message("STARTING INTEGRATED ZERO-ARM NB-EXCESS SENSITIVITY CHECK")
message("============================================================")

# Verify that the primary analysis above completed and created everything
# needed by the sensitivity analysis.
required_objects <- c(
  "count_mat",
  "group_labels",
  "normalized_counts",
...
if (length(missing_objects) > 0L) {
  stop(
    "Primary analysis did not create required objects: ",
